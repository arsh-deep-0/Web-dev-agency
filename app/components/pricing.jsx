function Pricing({ pricingRef }) {
    return <>
        <div ref={pricingRef} id='pricing' className="flex-col  py-8 px-2 white-wire">
            <h2 className="text-center text-4xl  blue-text aoboshi h-12 underline lg:my-12 ani-t2 opacity-0mb-10 ">Pricing levels</h2>

            <div class="parent h-auto">
            <div className="flex flex-col gap-2 md:grid md:grid-cols-3 md:gap-8 md:pb-16">
            <div className="ani opacity-0flex flex-col bg-black items-center justify-center  rounded-md py-4 text-white my-2  px-2 md:w-full md:pt-24 md:h-full md:justify-start md:mt-12 flex-grow">
            ...
            <div className="ani opacity-0flex flex-col bg-black items-center justify-center  rounded-md py-4 text-white my-2 px-2 md:w-full md:pt-24 md:h-full md:justify-start flex-grow">
